extern "C" {
    fn sort_unstable_i32(data: *mut i32, len: usize);
    fn sort_unstable_i32_by(
        data: *mut i32,
        len: usize,
        cmp_fn: unsafe extern "C" fn(&i32, &i32, *mut u8) -> bool,
        cmp_fn_ctx: *mut u8,
    );
    fn sort_unstable_u64(data: *mut u64, len: usize);
    fn sort_unstable_u64_by(
        data: *mut u64,
        len: usize,
...
impl LibCxxSort for i32 {
    ...
    fn sort_by<F: FnMut(&i32, &i32) -> Ordering>(data: &mut [i32], compare: F) {
        make_libcxx_sort_by!(sort_unstable_i32_by, data, compare, i32);
    }
}
...
impl LibCxxSort for u64 {
    ...
    fn sort_by<F: FnMut(&u64, &u64) -> Ordering>(data: &mut [u64], compare: F) {
        make_libcxx_sort_by!(sort_unstable_u64_by, data, compare, u64);
    }
}
