...
namespace idisort {
    namespace internal {
        ...
        template <typename A, typename F>
        size_t partition_hoare_branchy(const A& array, const void* pivot, const F& is_less) {
            const size_t array_len = array.len();
        ...
        void quick_sort_impl(A& array, const void* ancestor_pivot, size_t limit, const F& is_less) {
            while (true) {
                ...
                // If the chosen pivot is equal to the predecessor, then it's the smallest element
                // in the slice. Partition the slice into elements equal to and elements greater
                // than the pivot. This case is usually hit when the slice contains many duplicate
                // elements.
                if (ancestor_pivot) {
        ...
        template <typename A, typename F>
        void quick_sort(A& array, const F& is_less) {
