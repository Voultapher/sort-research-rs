...
template <class D>
HWY_INLINE void MaybePrintVector(D d,
                                 const char* label,
                                 Vec<D> v,
                                 size_t start = 0,
                                 size_t max_lanes = 16) {
...
template <class Traits, typename T>
HWY_INLINE void Sort0To8(Traits st,
                         T* HWY_RESTRICT keys,
                         size_t num_lanes,
                         T* HWY_RESTRICT buf) {
...
template <size_t kVectors,
          ...
          class Traits,
          typename T = TFromD<D>>
HWY_INLINE void CopyHalfToPaddedBuf(D d,
                                    Traits st,
                                    T* HWY_RESTRICT keys,
                                    size_t num_lanes,
                                    T* HWY_RESTRICT buf) {
...
template <class Traits, typename T>
HWY_INLINE void Sort9To16(Traits st,
                          T* HWY_RESTRICT keys,
                          size_t num_lanes,
                          T* HWY_RESTRICT buf) {
  constexpr size_t kLPK = st.LanesPerKey();
...
template <class Traits, typename T>
HWY_INLINE void Sort17To32(Traits st,
                           T* HWY_RESTRICT keys,
                           size_t num_lanes,
                           T* HWY_RESTRICT buf) {
  constexpr size_t kLPK = st.LanesPerKey();
...
template <class Traits, typename T>
HWY_INLINE void Sort33To64(Traits st,
                           T* HWY_RESTRICT keys,
                           size_t num_lanes,
                           T* HWY_RESTRICT buf) {
  constexpr size_t kLPK = st.LanesPerKey();
...
template <class Traits, typename T>
HWY_INLINE void Sort65To128(Traits st,
                            T* HWY_RESTRICT keys,
                            size_t num_lanes,
                            T* HWY_RESTRICT buf) {
  constexpr size_t kLPK = st.LanesPerKey();
...
template <class Traits, typename T>
HWY_INLINE void Sort129To256(Traits st,
                             T* HWY_RESTRICT keys,
                             size_t num_lanes,
                             T* HWY_RESTRICT buf) {
  constexpr size_t kLPK = st.LanesPerKey();
...
HWY_NOINLINE void BaseCase(D d,
                           Traits st,
                           T* HWY_RESTRICT keys,
                           size_t num_lanes,
                           T* buf) {
...
HWY_INLINE size_t PartitionToMultipleOfUnroll(D d,
                                              Traits st,
                                              T* HWY_RESTRICT keys,
                                              size_t& num,
                                              const Vec<D> pivot,
...
template <class D, class Traits, typename T>
HWY_INLINE void StoreLeftRight(D d,
                               Traits st,
                               const Vec<D> v,
                               const Vec<D> pivot,
                               T* HWY_RESTRICT keys,
...
template <class D, class Traits, typename T>
HWY_INLINE void StoreLeftRight4(D d,
                                Traits st,
                                const Vec<D> v0,
                                const Vec<D> v1,
                                const Vec<D> v2,
...
template <class D, class Traits, typename T>
HWY_INLINE size_t Partition(D d,
                            Traits st,
                            T* HWY_RESTRICT keys,
                            size_t num,
                            const Vec<D> pivot,
...
template <class D, class Traits, typename T>
HWY_NOINLINE bool MaybePartitionTwoValue(D d,
                                         Traits st,
                                         T* HWY_RESTRICT keys,
                                         size_t num,
                                         const Vec<D> valueL,
...
template <class D, class Traits, typename T>
HWY_INLINE bool MaybePartitionTwoValueR(D d,
                                        Traits st,
                                        T* HWY_RESTRICT keys,
                                        size_t num,
                                        const Vec<D> valueL,
...
template <class D, class Traits, typename T>
HWY_INLINE bool PartitionIfTwoKeys(D d,
                                   Traits st,
                                   const Vec<D> pivot,
                                   T* HWY_RESTRICT keys,
                                   size_t num,
...
template <class D, class Traits, typename T>
HWY_INLINE bool PartitionIfTwoSamples(D d,
                                      Traits st,
                                      T* HWY_RESTRICT keys,
                                      size_t num,
...
template <class D, class Traits, typename T>
HWY_INLINE void DrawSamples(D d,
                            Traits st,
                            T* HWY_RESTRICT keys,
                            size_t num,
                            T* HWY_RESTRICT buf,
...
HWY_INLINE bool UnsortedSampleEqual(D d,
                                    Traits st,
...
template <class D, class Traits, typename T>
HWY_INLINE Vec<D> ChoosePivotByRank(D d,
                                    Traits st,
...
template <class D, class Traits, typename T>
HWY_INLINE bool ExistsAnyBefore(D d,
                                Traits st,
                                const T* HWY_RESTRICT keys,
                                size_t num,
                                const Vec<D> pivot) {
...
// Called from 'two locations', but only one is active (IsKV is constexpr).
template <class D, class Traits, typename T>
HWY_INLINE bool ExistsAnyAfter(D d,
                               Traits st,
                               const T* HWY_RESTRICT keys,
                               size_t num,
                               const Vec<D> pivot) {
...
// (thus the right partition will never be empty).
template <class D, class Traits, typename T>
HWY_INLINE Vec<D> ChoosePivotForEqualSamples(D d,
                                             Traits st,
                                             T* HWY_RESTRICT keys,
                                             size_t num,
                                             T* HWY_RESTRICT samples,
...
template <class D, class Traits, typename T>
HWY_NOINLINE void PrintMinMax(D d,
                              Traits st,
                              const T* HWY_RESTRICT keys,
                              size_t num,
                              T* HWY_RESTRICT buf) {
...
template <class D, class Traits, typename T>
HWY_INLINE bool HandleSpecialCases(D d,
                                   Traits st,
                                   T* HWY_RESTRICT keys,
                                   size_t num,
                                   T* HWY_RESTRICT buf) {
