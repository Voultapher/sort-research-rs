...
HWY_INLINE void
Sort8(D d, Traits st, V& v0, V& v1, V& v2, V& v3, V& v4, V& v5, V& v6, V& v7) {
  st.Sort2(d, v0, v2);
  st.Sort2(d, v1, v3);
  st.Sort2(d, v4, v6);
  st.Sort2(d, v5, v7);
...
template <class D, class Traits, class V = Vec<D>>
HWY_INLINE void Merge16x16(D d,
                           Traits st,
                           V& v0,
                           V& v1,
                           V& v2,
...
HWY_INLINE void SortingNetwork(Traits st,
                               size_t cols,
                               V& v0,
                               V& v1,
                               V& v2,
