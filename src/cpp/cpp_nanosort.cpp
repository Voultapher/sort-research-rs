...
void nanosort_unstable_ffi_string(FFIString* data, size_t len) {
    nanosort(reinterpret_cast<FFIStringCpp*>(data), reinterpret_cast<FFIStringCpp*>(data) + len);
}
...
void nanosort_unstable_f128(F128* data, size_t len) {
    nanosort(reinterpret_cast<F128Cpp*>(data), reinterpret_cast<F128Cpp*>(data) + len);
}
...
void nanosort_unstable_1k(FFIOneKibiByte* data, size_t len) {
    nanosort(reinterpret_cast<FFIOneKibiByteCpp*>(data),
             reinterpret_cast<FFIOneKibiByteCpp*>(data) + len);
}

uint32_t nanosort_unstable_1k_by(FFIOneKibiByte* data,
                                 size_t len,
