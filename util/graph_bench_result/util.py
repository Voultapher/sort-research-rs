...
def build_implementation_meta_info():
    ...
    meta_info = {
        "c_crumsort_unstable": (palette[0], "square", "solid"),
        "c_fluxsort_stable": (palette[0], "square", "solid"),
        "c_gnu_libc_unstable": (palette[3], "diamond", "solid"),
        "c_idisort_unstable": (palette[6], "triangle", "solid"),
        "c_llvm_libc_unstable": (palette[7], "square_cross", "solid"),
        "c_std_sys_unstable": (palette[1], "square_pin", "solid"),

        "cpp_blockquicksort_unstable": (palette[7], "square", "solid"),
        "cpp_intel_avx512": (palette[7], "square", "solid"),
        "cpp_ips4o_unstable": (palette[6], "square", "solid"),
        "cpp_pdqsort_unstable": (palette[3], "square", "solid"),
        "cpp_powersort_4way_stable": (palette[7], "square", "solid"),
        "cpp_powersort_stable": (palette[6], "square", "solid"),
        "cpp_std_gnu_stable": (palette[1], "square", "solid"),
        "cpp_std_gnu_unstable": (palette[1], "square", "solid"),
        "cpp_std_libcxx_stable": (palette[4], "square", "solid"),
        "cpp_std_libcxx_unstable": (palette[4], "square", "solid"),
        "cpp_std_msvc_stable": (palette[1], "square", "solid"),
        "cpp_std_msvc_unstable": (palette[1], "square", "solid"),
        "cpp_std_sys_stable": (palette[1], "square", "solid"),
        "cpp_std_sys_unstable": (palette[1], "square", "solid"),
        "cpp_vqsort": (palette[6], "square", "solid"),

        "rust_crumsort_rs_unstable": (palette[6], "square", "solid"),
        "rust_driftsort_stable": (palette[7], "square", "solid"),
        "rust_glidesort_stable": (palette[3], "triangle", "solid"),
        "rust_ipn_stable": (palette[5], "square", "solid"),
        "rust_ipn_unstable": (palette[5], "square", "solid"),
        "rust_ipnsort_unstable": (palette[5], "circle", "solid"),
        "rust_radsort_radix": (palette[4], "square", "solid"),
        "rust_std_stable": (palette[4], "square", "solid"),
        "rust_std_unstable": (palette[5], "circle", "solid"),
        "rust_std_vendored_stable": (palette[4], "square", "solid"),
        "rust_std_vendored_unstable": (palette[4], "square", "solid"),
        "rust_tinyheapsort_unstable": (palette[7], "square", "solid"),
        "rust_tinymergesort_stable": (palette[7], "square", "solid"),
        "rust_wpwoodjr_stable": (palette[7], "square", "solid"),

        "singeli_singelisort": (palette[3], "square", "solid"),

        "bucket_btree": (palette[3], "diamond", "solid"),
        "bucket_hash": (palette[0], "triangle", "solid"),
        "bucket_match": (palette[6], "square_cross", "solid"),
        "bucket_branchless": (palette[4], "square_cross", "solid"),
        "bucket_phf": (palette[7], "square_pin", "solid"),

        # For partition bench
        "hoare_branchy": (palette[1], "diamond", "solid"),
        "hoare_block": (palette[4], "plus", "solid"),
        "hoare_crumsort": (palette[3], "square_pin", "solid"),
        "lomuto_branchy": (palette[0], "square", "solid"),
        "lomuto_branchless": (palette[5], "circle", "solid"),
        "lomuto_branchless_cyclic": (palette[6], "square_cross", "solid"),
        "lomuto_branchless_cyclic_opt": (palette[7], "triangle", "solid"),
